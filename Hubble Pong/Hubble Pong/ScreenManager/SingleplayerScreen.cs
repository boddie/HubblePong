...
namespace Hubble_Pong.ScreenManager
{
    ...
    /// singleplayer. This differs from multiplayer because it adds
    /// in an AI controlled paddle instead of two user controlled 
    /// ones.
    /// </summary>
    class SingleplayerScreen : Screen
    {
        ...
        #region Constructor and Inherited/Overridden Screen Methods
        ...
        ///     XBOX - Controller (Just player one since single player)
